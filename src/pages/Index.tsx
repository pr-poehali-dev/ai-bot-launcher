...
const Index = () => {
  ...
  const packages = [
    {
      ...
      icon: "Rocket",
      features: [
        "Готовый AI-агент под вашу нишу",
    ...
    },
    {
      ...
      popular: true,
      features: [
        "Индивидуальный сценарий агента",
        "Интеграция с 3 платформами",
        "Обучение агента на ваших данных",
        "Подключение к CRM",
        "1 месяц поддержки",
        "Видео-демо работы"
      ]
  ...
  const testimonials = [
    {
      ...
      text: "За неделю агент обработал 200+ заявок. Менеджеры освободились для сложных клиентов. ROI окупился за месяц!",
      rating: 5
    },
    {
      name: "Марина К.",
    ...
    },
    {
      name: "Дмитрий П.",
      role: "SMM-агентство",
      text: "Агент генерирует контент для 12 клиентов. Качество не хуже копирайтера, а скорость в 10 раз выше.",
      rating: 5
    }
  ];
  ...
  const faqs = [
    {
      q: "Как быстро можно запустить агента?",
      a: "Для готовых решений — от 5 дней. Индивидуальные сценарии — от 7 дней. Всё зависит от сложности интеграций."
    },
    {
      q: "Нужны ли технические знания?",
      a: "Нет! Я всё настрою под ключ. Вы получите готового агента с инструкцией и обучением."
    },
    {
    ...
    {
      q: "А если агент не справится с вопросом?",
      a: "Настраиваем сценарий передачи сложных запросов живому оператору. Агент знает свои границы."
    },
    {
      q: "Есть ли гарантии?",
        ...
        <section className="container mx-auto px-4 py-20 md:py-32">
          <div className="max-w-5xl mx-auto text-center space-y-8 animate-fade-in">
            ...
            <h1 className="text-5xl md:text-7xl font-bold leading-tight">
              <span className="gradient-text">AI-агенты под ключ</span>
              <br />
              от 5 дней
            </h1>
            
            <p className="text-xl md:text-2xl text-muted-foreground max-w-3xl mx-auto">
              Автоматизирую продажи, поддержку и маркетинг с помощью интеллектуальных агентов на GPT, Gemini, ЯндексGPT
            </p>
            ...
            <div className="grid grid-cols-2 md:grid-cols-4 gap-6 pt-12 max-w-3xl mx-auto">
              {[
                ...
                { value: "от 5 дней", label: "Средний срок запуска" },
